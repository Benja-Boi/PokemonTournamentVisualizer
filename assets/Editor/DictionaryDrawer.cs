...
namespace Editor
{
    [CustomPropertyDrawer(typeof(SpriteDictionary))] // Name of your class (same as above)
    public class ImageDictionaryDrawer : DictionaryDrawer<string, Sprite> { } // chose same types as your dictionary
